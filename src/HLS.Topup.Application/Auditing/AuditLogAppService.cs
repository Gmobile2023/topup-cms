...
using HLS.Topup.Auditing.Exporting;
using HLS.Topup.Authorization;
using HLS.Topup.Authorization.Users;
using HLS.Topup.Dto;
using HLS.Topup.EntityHistory;
using EntityHistoryHelper = HLS.Topup.EntityHistory.EntityHistoryHelper;

namespace HLS.Topup.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TopupAppServiceBase, IAuditLogAppService
    {
