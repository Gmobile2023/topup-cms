    ...
    public class HostSettingsAppService : SettingsAppServiceBase, IHostSettingsAppService
    {
        ...
        private async Task<HostUserManagementSettingsEditDto> GetUserManagementAsync()
        {
            return new HostUserManagementSettingsEditDto
            {
                ...
                // OdpVerificationEnabled =
                //     await SettingManager.GetSettingValueAsync<bool>(AppSettings.UserManagement.OdpVerificationEnabled),
                // OtpVerificationEnabled =
                //     await SettingManager.GetSettingValueAsync<bool>(AppSettings.UserManagement.OtpVerificationEnabled),
        ...
        {
            var obj = new OtpSettingsEditDto
            {
        ...
        private async Task UpdateUserManagementSettingsAsync(HostUserManagementSettingsEditDto settings)
        {
            ...
            // await SettingManager.ChangeSettingForApplicationAsync(
            //     AppSettings.UserManagement.OtpVerificationEnabled,
            //     settings.OtpVerificationEnabled.ToString().ToLowerInvariant()
            // );

            // await SettingManager.ChangeSettingForApplicationAsync(
            //     AppSettings.UserManagement.OdpVerificationEnabled,
            //     settings.OdpVerificationEnabled.ToString().ToLowerInvariant()
            // );
        ...
        private async Task UpdateOtpSettingsAsync(OtpSettingsEditDto settings)
        {
            ...
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.OtpSetting.IsEnabled, settings.IsEnabled.ToString().ToLowerInvariant());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsOtpPass, settings.IsOtpPass.ToString().ToLowerInvariant());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsOdpVerificationEnabled, settings.IsOdpVerificationEnabled.ToString().ToLowerInvariant());
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.OtpSetting.IsOtpVerificationEnabled, settings.IsOtpVerificationEnabled.ToString().ToLowerInvariant());
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.OtpSetting.IsOtpIsEncrypted, settings.IsOtpIsEncrypted.ToString().ToLowerInvariant());
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.OtpSetting.MaxFailed, settings.MaxFailed.ToString());
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.UserManagement.OtpSetting.OdpAvailable, settings.OdpAvailable.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.OtpTimeOut, settings.OtpTimeOut.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.OdpMaxSend, settings.OdpMaxSend.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseOdpRegister, settings.IsUseOdpRegister.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseOdpResetPass, settings.IsUseOdpResetPass.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsLevelPassVerificationEnabled, settings.IsLevelPassVerificationEnabled.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.DefaultVerifyTransId, settings.DefaultVerifyTransId.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseOdpLogin, settings.IsUseOdpLogin.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseVerifyLogin, settings.IsUseVerifyLogin.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseVerifyRegister, settings.IsUseVerifyRegister.ToString());
            await SettingManager.ChangeSettingForApplicationAsync( AppSettings.UserManagement.OtpSetting.IsUseVerifyResetPass, settings.IsUseVerifyResetPass.ToString());
