...
using HLS.Topup.DynamicEntityPropertyValues.Dto;

namespace HLS.Topup.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : TopupAppServiceBase, IDynamicEntityPropertyValueAppService
    {
