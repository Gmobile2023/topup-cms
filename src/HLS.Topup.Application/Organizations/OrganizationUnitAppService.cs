...
namespace HLS.Topup.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : TopupAppServiceBase, IOrganizationUnitAppService
    {
        private readonly OrganizationUnitManager _organizationUnitManager;
        private readonly IRepository<OrganizationUnit, long> _organizationUnitRepository;
        private readonly IRepository<UserOrganizationUnit, long> _userOrganizationUnitRepository;
        private readonly IRepository<OrganizationUnitRole, long> _organizationUnitRoleRepository;
        private readonly IRepository<OrganizationsUnitCustom, long> _organizationUnitCustomRepository;
        ...
        public OrganizationUnitAppService(
            ...
            IRepository<OrganizationsUnitCustom, long> organizationUnitCustomRepository)
        {
            ...
            _organizationUnitCustomRepository = organizationUnitCustomRepository;
        }
        ...
        {
            var organizationUnit = await _organizationUnitCustomRepository.GetAsync(input.Id);
