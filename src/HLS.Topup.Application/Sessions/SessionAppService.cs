...
{
    public class SessionAppService : TopupAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = TopupConsts.Currency,
                    CurrencySign = TopupConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = TopupConsts.AllowTenantsToChangeEmailSettings,
