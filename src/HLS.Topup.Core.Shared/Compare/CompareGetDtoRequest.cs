...
namespace HLS.Topup.Compare
{
    ...
    public class ReportCompareListRequest : PaggingBaseDto
    {
    ...
    public class ReportCompareDetailReonseRequest : PaggingBaseDto
    {
    ...
    public class ReportCompareReonseRequest : PaggingBaseDto
    {
    ...
    public class ReportCompareRefundDetailRequest : PaggingBaseDto
    {
        public string KeyCode { get; set; }
        public string ProviderCode { get; set; }
    ...
    public class ReportCompareRefundRequest : PaggingBaseDto
    {
    ...
    /// <summary>
    /// Hoàn tiền theo Provider,Ngay giao dich
    /// </summary>
    [Route("/api/v1/report/ReportCompareRefundSingle", "GET")]
    public class ReportCompareRefundSingleRequest : PaggingBaseDto
    {
        public string KeyCode { get; set; }
        public string ProviderCode { get; set; }
    }
    ...
    public class CompareProviderRequest
    {
        ...
        public int RefundAutoQuantity { get; set; }

        public decimal RefundAutoAmount { get; set; }
    }
    ...
    public class ReportCheckCompareRequest 
    {
