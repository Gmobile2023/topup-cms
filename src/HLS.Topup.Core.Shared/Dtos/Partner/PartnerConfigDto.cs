...
namespace HLS.Topup.Dtos.Partner
{
    public class PartnerConfigTransDto
    {
        ...
        public List<string> ServiceConfigList { get; set; }
        public string CategoryConfigs { get; set; }
        public List<string> CategoryConfigList { get; set; }
        ...
        public List<string> ProductConfigsNotAllowList { get; set; }
