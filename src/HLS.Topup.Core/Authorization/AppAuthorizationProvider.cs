...
namespace HLS.Topup.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var lowBalanceAlerts = pagesBackend.CreateChildPermission(AppPermissions.Pages_LowBalanceAlerts, L("LowBalanceAlerts"));
            lowBalanceAlerts.CreateChildPermission(AppPermissions.Pages_LowBalanceAlerts_Create, L("LowBalanceAlertsCreate"));
            lowBalanceAlerts.CreateChildPermission(AppPermissions.Pages_LowBalanceAlerts_Edit, L("LowBalanceAlertsEdit"));

            var providerReconcile = pagesBackend.CreateChildPermission(AppPermissions.Pages_ProviderReconcile, L("ProviderReconcile"));
            providerReconcile.CreateChildPermission(AppPermissions.Pages_ProviderReconcile_Comapre, L("ProviderReconcile_Comapre"));

            var refundsReconcile = pagesBackend.CreateChildPermission(AppPermissions.Pages_RefundsReconcile, L("RefundsReconcile"));
            refundsReconcile.CreateChildPermission(AppPermissions.Pages_RefundsReconcile_Approval, L("RefundsReconcile_Approval"));

            var auditActivities = pagesBackend.CreateChildPermission(AppPermissions.Pages_AuditActivities, L("AuditActivities"));

            var payment=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_CreatePayment, L("Pages_CreatePayment"));
            var requestDeposit=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_RequestDeposit, L("Pages_RequestDeposit"));
            var transfer=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_TransferMoney, L("Pages_TransferMoney"));
            var balanceHistory=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_BalanceHistory, L("Pages_BalanceHistory"));
            var batchLotHistory = pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_BatchLotHistory, L("Pages_BatchLotHistory"));
            batchLotHistory.CreateChildPermission(AppPermissions.Pages_BatchLotStop, L("BatchLotStop"));
            var batchLotPayment = pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_CreateBatchLotPayment, L("Pages_CreateBatchLotPayment"));
            ...
            var transactionHistory=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_TransactionHistory, L("Pages_TransactionHistory"));
            var agentParentFontend = pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_Report_CommissionAgentGeneral, L("ReportCommissionAgentGeneral"));
            agentParentFontend.CreateChildPermission(AppPermissions.Pages_Report_CommissionAgentDetail, L("ReportCommissionAgentDetail"));
            agentParentFontend.CreateChildPermission(AppPermissions.Pages_Report_CommissionAgentTotal, L("ReportCommissionAgentTotal"));
            agentParentFontend.CreateChildPermission(AppPermissions.Pages_Report_CommissionAgentDash, L("ReportCommissionAgentDash"));


            var staffManager=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_StaffManager, L("Pages_StaffManager"));
            staffManager.CreateChildPermission(AppPermissions.Pages_StaffManager_Create, L("Pages_StaffManager_Create"));
            staffManager.CreateChildPermission(AppPermissions.Pages_StaffManager_Update, L("Pages_StaffManager_Update"));
            staffManager.CreateChildPermission(AppPermissions.Pages_StaffManager_Delete, L("Pages_StaffManager_Delete"));
            var agentManager=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_AgentManager, L("Pages_AgentManager"));
            agentManager.CreateChildPermission(AppPermissions.Pages_AgentManager_Create, L("Pages_AgentManager_Create"));

            var postManagement=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_PostManagement, L("Pages_PostManagement"));
            postManagement.CreateChildPermission(AppPermissions.Pages_PostManagement_Create, L("Pages_PostManagement_Create"));
            postManagement.CreateChildPermission(AppPermissions.Pages_PostManagement_Edit, L("Pages_PostManagement_Edit"));

            var subAgentManagement=pagesFrontEnd.CreateChildPermission(AppPermissions.Pages_SubAgentManagement, L("Pages_SubAgentManagement"));
            subAgentManagement.CreateChildPermission(AppPermissions.Pages_SubAgentManagement_Create, L("Pages_SubAgentManagement_Create"));
            subAgentManagement.CreateChildPermission(AppPermissions.Pages_SubAgentManagement_Edit, L("Pages_SubAgentManagement_Edit"));
            subAgentManagement.CreateChildPermission(AppPermissions.Pages_SubAgentManagement_Lock, L("Pages_SubAgentManagement_Lock"));
            subAgentManagement.CreateChildPermission(AppPermissions.Pages_SubAgentManagement_Unlock, L("Pages_SubAgentManagement_Unlock"));
            ...
            var topupMessageResponse = pagesBackend.CreateChildPermission(AppPermissions.Pages_TopupGateResponseMessage, L("TopupGateResponseMessageManagerment"));
            
            topupMessageResponse.CreateChildPermission(AppPermissions.Pages_TopupGateResponseMessage_Create, L("CreateTopupGateResponseMessage"));
            topupMessageResponse.CreateChildPermission(AppPermissions.Pages_TopupGateResponseMessage_Edit, L("EditTopupGateResponseMessage"));
            ...
            deposits.CreateChildPermission(AppPermissions.Pages_Deposits_AccountingEntry, L("CreateNewAccountingEntry"));
            ...
            var serviceConfigurations = pagesBackend.CreateChildPermission(AppPermissions.Pages_ServiceConfigurations, L("ServiceConfigurations"));
            serviceConfigurations.CreateChildPermission(AppPermissions.Pages_ServiceConfigurations_Create, L("CreateNewServiceConfiguration"));
            serviceConfigurations.CreateChildPermission(AppPermissions.Pages_ServiceConfigurations_Edit, L("EditServiceConfiguration"));
            serviceConfigurations.CreateChildPermission(AppPermissions.Pages_ServiceConfigurations_Delete, L("DeleteServiceConfiguration"));

            var systemAccountTransfers = pagesBackend.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers, L("SystemAccountTransfers"));
            systemAccountTransfers.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers_Create, L("CreateNewSystemAccountTransfer"));
            systemAccountTransfers.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers_Edit, L("EditSystemAccountTransfer"));
            systemAccountTransfers.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers_Approval, L("ApprovalSystemAccountTransfer"));
            systemAccountTransfers.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers_Cancel, L("CancelSystemAccountTransfer"));
            systemAccountTransfers.CreateChildPermission(AppPermissions.Pages_SystemAccountTransfers_Delete, L("DeleteSystemAccountTransfer"));



            var payBatchBills = pagesBackend.CreateChildPermission(AppPermissions.Pages_PayBatchBills, L("PayBatchBills"));
            ...
            var accountBlockBalances = pagesBackend.CreateChildPermission(AppPermissions.Pages_AccountBlockBalances, L("AccountBlockBalances"));
            accountBlockBalances.CreateChildPermission(AppPermissions.Pages_AccountBlockBalances_Create, L("CreateNewAccountBlockBalance"));
            accountBlockBalances.CreateChildPermission(AppPermissions.Pages_AccountBlockBalances_Edit, L("EditAccountBlockBalance"));
            accountBlockBalances.CreateChildPermission(AppPermissions.Pages_AccountBlockBalances_Delete, L("DeleteAccountBlockBalance"));



            var limitProducts = pagesBackend.CreateChildPermission(AppPermissions.Pages_LimitProducts, L("LimitProducts"));
            ...
            var agentsManage = pagesBackend.CreateChildPermission(AppPermissions.Pages_AgentsManage, L("AgentsMangerment"));
            ...
            var agentsSupper = pagesBackend.CreateChildPermission(AppPermissions.Pages_AgentsSupper, L("AgentsSupperTotal"));
            ...
            var saleClearDebts = pagesBackend.CreateChildPermission(AppPermissions.Pages_SaleClearDebts, L("SaleClearDebts"));
            saleClearDebts.CreateChildPermission(AppPermissions.Pages_SaleClearDebts_Create, L("CreateNewSaleClearDebt"));
            ...
            saleClearDebts.CreateChildPermission(AppPermissions.Pages_SaleClearDebts_Approval, L("ApprovalSaleClearDebt"));
            saleClearDebts.CreateChildPermission(AppPermissions.Pages_SaleClearDebts_Cancel, L("CancelSaleClearDebt"));



            var saleLimitDebts = pagesBackend.CreateChildPermission(AppPermissions.Pages_SaleLimitDebts, L("SaleLimitDebts"));
            saleLimitDebts.CreateChildPermission(AppPermissions.Pages_SaleLimitDebts_Create, L("CreateNewSaleLimitDebt"));
            ...
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportDetailBalanceAccount, L("ReportDetailBalanceAccount"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportSumBalanceAccount, L("ReportSumBalanceAccount"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportSumTotalBalanceAccount, L("ReportSumTotalBalanceAccount"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_TopupTransaction, L("ReportTopupTransaction"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_CardStockHistories, L("ReportCardStockHistories"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_CardStockImExPort, L("ReportCardStockImExPort"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_CardStockImExProvider, L("ReportCardStockImExProvider"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_CardStockInventory, L("ReportCardStockInventory"));
            ...
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportServiceProvider, L("ReportServiceProvider"));
            ...
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportCommissionDetail, L("ReportCommissionDetail"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportCommissionTotal, L("ReportCommissionTotal"));
            reports.CreateChildPermission(AppPermissions.Pages_Report_ReportTopupRequestLogs, L("ReportTopupRequestLogs"));


            var topupRequests = pagesBackend.CreateChildPermission(AppPermissions.Pages_TransactionManagements, L("TopupRequests"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_Create, L("CreateNewTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_Edit, L("EditTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_Delete, L("DeleteTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_Cancel, L("CancelTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_Refund, L("RefundTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_PinCode, L("ViewPinCodeTopupRequest"));
            topupRequests.CreateChildPermission(AppPermissions.Pages_TransactionManagements_StatusFile, L("SysnStatusFileTopupRequest"));

            pagesBackend.CreateChildPermission(AppPermissions.Pages_DemoUiComponents, L("DemoUiComponents"));


            var notificationSchedules = pagesBackend.CreateChildPermission(AppPermissions.Pages_NotificationSchedules, L("NotificationSchedules"));
            notificationSchedules.CreateChildPermission(AppPermissions.Pages_NotificationSchedules_Create, L("CreateNewNotificationSchedule"));
            notificationSchedules.CreateChildPermission(AppPermissions.Pages_NotificationSchedules_Edit, L("EditNotificationSchedule"));
            notificationSchedules.CreateChildPermission(AppPermissions.Pages_NotificationSchedules_Delete, L("DeleteNotificationSchedule"));
            notificationSchedules.CreateChildPermission(AppPermissions.Pages_NotificationSchedules_Approval, L("Approval"));
            ...
            var partnerServiceConfigurations = pagesBackend.CreateChildPermission(AppPermissions.Pages_PartnerServiceConfigurations, L("PartnerServiceConfigurations"));
            partnerServiceConfigurations.CreateChildPermission(AppPermissions.Pages_PartnerServiceConfigurations_Create, L("CreateNewPartnerServiceConfiguration"));
            partnerServiceConfigurations.CreateChildPermission(AppPermissions.Pages_PartnerServiceConfigurations_Edit, L("EditPartnerServiceConfiguration"));
            partnerServiceConfigurations.CreateChildPermission(AppPermissions.Pages_PartnerServiceConfigurations_Delete, L("DeletePartnerServiceConfiguration"));
        }
