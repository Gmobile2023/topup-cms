    ...
    public class AppSettingProvider : SettingProvider
    {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        TopupConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetSharedSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.WebPaymentMethod,
                    GetFromAppSettings(AppSettings.UserManagement.WebPaymentMethod, "0"),
                    isVisibleToClients: true, scopes: SettingScopes.User),

                new SettingDefinition(AppSettings.UserManagement.AppPaymentMethod,
                    GetFromAppSettings(AppSettings.UserManagement.AppPaymentMethod, "0"),
                    isVisibleToClients: true, scopes: SettingScopes.User)
            };
        }

        private IEnumerable<SettingDefinition> GetOtpSettings()
        {
            return new[]
            {
                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsEnabled,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsEnabled, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsOtpPass,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsOtpPass, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsOdpVerificationEnabled,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsOdpVerificationEnabled, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsOtpVerificationEnabled,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsOtpVerificationEnabled, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsOtpIsEncrypted,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsOtpIsEncrypted, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.MaxFailed,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.MaxFailed, "3"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.OdpAvailable,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.OdpAvailable, "1140"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.OtpTimeOut,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.OtpTimeOut, "60"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.OdpMaxSend,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.OdpMaxSend, "1"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseOdpRegister,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseOdpRegister, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseOdpResetPass,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseOdpResetPass, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseOdpLogin,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseOdpLogin, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsLevelPassVerificationEnabled,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsLevelPassVerificationEnabled, "true"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.DefaultVerifyTransId,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.DefaultVerifyTransId, "1"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseVerifyLogin,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseVerifyLogin, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseVerifyRegister,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseVerifyRegister, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettings.UserManagement.OtpSetting.IsUseVerifyResetPass,
                    GetFromAppSettings(AppSettings.UserManagement.OtpSetting.IsUseVerifyResetPass, "false"),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, isVisibleToClients: true),
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    TopupDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    TopupDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = TopupDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = TopupDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = TopupDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        TopupDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = TopupDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = TopupDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        TopupDashboardCustomizationConsts.Widgets.Host
