...
namespace HLS.Topup.MultiTenancy
{
    public class SubscriptionExpirationCheckWorker : PeriodicBackgroundWorkerBase, ISingletonDependency
    {
        ...
        public SubscriptionExpirationCheckWorker(
            ...
            UserEmailer userEmailer, IUnitOfWorkManager unitOfWorkManager)
            : base(timer)
        {
            ...
            _unitOfWorkManager.WithUnitOfWork(() =>
            {
                ...
                foreach (var tenant in subscriptionExpiredTenants)
                {
                    ...
                    try
                    {
                        ...
                        var endSubscriptionResult = AsyncHelper.RunSync(() =>
                            _tenantManager.EndSubscriptionAsync(tenant, edition, utcNow));
