    ...
    public partial class TransactionManager : TopupDomainServiceBase, ITransactionManager
    {
        ...
        public async Task<NewMessageReponseBase<BalanceResponseDto>> TransactionRefundRequestAsync(TransactionRefundRequest input)
        {
            ...
            try
            {
                ...
                {
                    ResponseStatus = new ResponseStatus(ResponseCodeConst.ResponseCode_WaitForResult, "Giao dịch chưa có kết quả. Xin vui lòng chờ kết quả")
                };
            }
            catch (Exception ex)
            {
            ...
            ProviderCheckTransStatusRequest input)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                {
                    ResponseStatus = new ResponseStatus(ResponseCodeConst.Error, "Check giao dịch không thành công"),
