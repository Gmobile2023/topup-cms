    ...
    public partial class init_db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpGeneratorIds", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AbpIdentittyServerStorage",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    AllowedGrantTypes = table.Column<string>(type: "text", nullable: true),
                    AllowedScopes = table.Column<string>(type: "text", nullable: true),
                    ClientSecrets = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpIdentittyServerStorage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountSend = table.Column<int>(type: "integer", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpOdps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpOtps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PhoneNumer = table.Column<string>(type: "varchar(50)", nullable: true),
                    Message = table.Column<string>(type: "character(255)", nullable: true),
                    Result = table.Column<string>(type: "character(255)", nullable: true),
                    Channel = table.Column<string>(type: "varchar(50)", nullable: true),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpSmsMessage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountCode = table.Column<string>(type: "varchar(50)", nullable: true),
                    ParentCode = table.Column<string>(type: "varchar(50)", nullable: true),
                    MobileOtp = table.Column<string>(type: "varchar(20)", nullable: true),
                    TreePath = table.Column<string>(type: "varchar(500)", nullable: true),
                    ParentId = table.Column<long>(type: "bigint", nullable: true),
                    Level2Password = table.Column<string>(type: "varchar(255)", nullable: true),
                    AccessFailedCountLevel2Pass = table.Column<int>(type: "integer", nullable: true),
                    Description = table.Column<string>(type: "character(500)", nullable: true),
                    LockTransDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AccountType = table.Column<byte>(type: "smallint", nullable: false),
                    AgentType = table.Column<byte>(type: "smallint", nullable: false),
                    DoB = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Gender = table.Column<byte>(type: "smallint", nullable: true),
                    NetworkLevel = table.Column<int>(type: "integer", nullable: false),
                    IsDefaultEmail = table.Column<bool>(type: "boolean", nullable: false),
                    IsVerifyAccount = table.Column<bool>(type: "boolean", nullable: false),
                    AgentName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserSaleLeadId = table.Column<long>(type: "bigint", nullable: true),
                    LockAccountNote = table.Column<string>(type: "character(255)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_AbpUsers_UserSaleLeadId",
                        column: x => x.UserSaleLeadId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAccountCode = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    Images = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    SmsPhoneNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    SmsGatewayNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    SmsSyntax = table.Column<string>(type: "character varying(600)", maxLength: 600, nullable: true),
                    NoteSyntax = table.Column<string>(type: "character varying(600)", maxLength: 600, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayBacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderStatus = table.Column<byte>(type: "smallint", nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    TransCodeConfig = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsSlowTrans = table.Column<bool>(type: "boolean", nullable: true),
                    ParentProvider = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsAutoDeposit = table.Column<bool>(type: "boolean", nullable: false),
                    IsRoundRobinAccount = table.Column<bool>(type: "boolean", nullable: false),
                    MinBalance = table.Column<decimal>(type: "numeric", nullable: false),
                    MinBalanceToDeposit = table.Column<decimal>(type: "numeric", nullable: false),
                    DepositAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    WorkShortCode = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicesName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ServiceConfig = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    Order = table.Column<int>(type: "integer", nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SystemAccountTransfers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    TransCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SrcAccount = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    DesAccount = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Attachments = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    ApproverId = table.Column<long>(type: "bigint", nullable: true),
                    DateApproved = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemAccountTransfers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    Print_Help = table.Column<string>(type: "text", nullable: true),
                    Print_Suport = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpOrganizationUnits_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    TransCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    BlockedMoney = table.Column<decimal>(type: "numeric", nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountBlockBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountBlockBalances_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    NewUserName = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    OldUserName = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ApproverId = table.Column<long>(type: "bigint", nullable: true),
                    DateApproved = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChangeUserNameHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChangeUserNameHistories_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproverId = table.Column<long>(type: "bigint", nullable: true),
                    AgentType = table.Column<byte>(type: "smallint", nullable: false),
                    Desciptions = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discounts_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductList = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitProducts_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateSchedule = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationSchedules_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleUserId = table.Column<long>(type: "bigint", nullable: false),
                    UserAgentId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleAssignAgents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleAssignAgents_AbpUsers_SaleUserId",
                        column: x => x.SaleUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleAssignAgents_AbpUsers_UserAgentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleClearDebtHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleClearDebtHistories_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebtAge = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleLimitDebts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleLimitDebts_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    LimitAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    LimitPerTrans = table.Column<decimal>(type: "numeric", nullable: false),
                    Days = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    FromTime = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ToTime = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffConfigurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StaffConfigurations_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ExtraInfo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    BankId = table.Column<int>(type: "integer", nullable: true),
                    RecipientInfo = table.Column<string>(type: "text", nullable: true),
                    ApproverId = table.Column<long>(type: "bigint", nullable: true),
                    UserSaleId = table.Column<long>(type: "bigint", nullable: true),
                    Attachment = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    TransCodeBank = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RequestCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deposits_AbpUsers_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Deposits_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deposits_AbpUsers_UserSaleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "integer", nullable: false),
                    Descriptions = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ApprovalNote = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    BankId = table.Column<int>(type: "integer", nullable: true),
                    TransCodeBank = table.Column<string>(type: "text", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleClearDebts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleClearDebts_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleClearDebts_Banks_BankId",
                        column: x => x.BankId,
                        principalTable: "Banks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    PayBackId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Status = table.Column<bool>(type: "boolean", nullable: true),
                    TransCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TransNote = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayBackDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayBackDetails_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayBackDetails_PayBacks_PayBackId",
                        column: x => x.PayBackId,
                        principalTable: "PayBacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AccountBlockBalanceDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Attachments = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Type = table.Column<byte>(type: "smallint", nullable: false),
                    Success = table.Column<bool>(type: "boolean", nullable: false),
                    TransRef = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TransNote = table.Column<string>(type: "character varying(2500)", maxLength: 2500, nullable: true),
                    AccountBlockBalanceId = table.Column<int>(type: "integer", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountBlockBalanceDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountBlockBalanceDetails_AccountBlockBalances_AccountBloc~",
                        column: x => x.AccountBlockBalanceId,
                        principalTable: "AccountBlockBalances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "integer", nullable: false),
                    ProductValue = table.Column<decimal>(type: "numeric", nullable: true),
                    ProductType = table.Column<byte>(type: "smallint", nullable: false),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    Unit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RefValue = table.Column<decimal>(type: "numeric", nullable: true),
                    Image = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CustomerSupportNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    UserManualNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    IsShowOnFrontend = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixAmount = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DiscountDetails_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AmountMinFee = table.Column<decimal>(type: "numeric", nullable: true),
                    MinFee = table.Column<decimal>(type: "numeric", nullable: true),
                    AmountIncrease = table.Column<decimal>(type: "numeric", nullable: true),
                    SubFee = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeeDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeeDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FeeDetails_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "LimitProductDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LimitAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    LimitQuantity = table.Column<int>(type: "integer", nullable: true),
                    LimitProductId = table.Column<int>(type: "integer", nullable: false),
                    ServiceId = table.Column<int>(type: "integer", nullable: true),
                    CategoryId = table.Column<int>(type: "integer", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitProductDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitProductDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LimitProductDetails_LimitProducts_LimitProductId",
                        column: x => x.LimitProductId,
                        principalTable: "LimitProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LimitProductDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LimitProductDetails_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    TotalAgent = table.Column<int>(type: "integer", nullable: false),
                    TotalTrans = table.Column<int>(type: "integer", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    FromDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ToDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TotalBlockBill = table.Column<int>(type: "integer", nullable: false),
                    AmountPayBlock = table.Column<decimal>(type: "numeric", nullable: false),
                    ApproverId = table.Column<long>(type: "bigint", nullable: true),
                    DateApproved = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    MinBillAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    MaxAmountPay = table.Column<decimal>(type: "numeric", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    CategoryId = table.Column<int>(type: "integer", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayBatchBills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayBatchBills_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PayBatchBills_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ServiceId = table.Column<int>(type: "integer", nullable: true),
                    ProviderSetTransactionTimeout = table.Column<int>(type: "integer", nullable: true),
                    ProviderMaxWaitingTimeout = table.Column<int>(type: "integer", nullable: true),
                    IsEnableResponseWhenJustReceived = table.Column<bool>(type: "boolean", nullable: true),
                    WaitingTimeResponseWhenJustReceived = table.Column<int>(type: "integer", nullable: true),
                    StatusResponseWhenJustReceived = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    IsLastConfiguration = table.Column<bool>(type: "boolean", nullable: false),
                    ProviderId = table.Column<int>(type: "integer", nullable: true),
                    CategoryId = table.Column<int>(type: "integer", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                    AllowTopupReceiverType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    RateRunning = table.Column<decimal>(type: "numeric", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceConfigurations_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ServiceConfigurations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ServiceConfigurations_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ServiceConfigurations_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontPhoto = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    BackSitePhoto = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    IdIdentity = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    IdType = table.Column<int>(type: "integer", nullable: false),
                    Desscription = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ExtraInfo = table.Column<string>(type: "text", nullable: true),
                    IdentityIdExpireDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ChatId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    LimitChannel = table.Column<int>(type: "integer", nullable: false),
                    IsApplySlowTrans = table.Column<bool>(type: "boolean", nullable: true),
                    SigDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PeriodCheck = table.Column<int>(type: "integer", nullable: false),
                    ContractNumber = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    TaxCode = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    EmailReceives = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ContactInfos = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    EmailTech = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    MethodReceivePassFile = table.Column<byte>(type: "smallint", nullable: true),
                    ValueReceivePassFile = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    FolderFtp = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpUserProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AbpUserProfile_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AbpUserProfile_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUserProfile_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUserProfile_Wards_WardId",
                        column: x => x.WardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleManLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleManLocations_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleManLocations_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SaleManLocations_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SaleManLocations_Wards_WardId",
                        column: x => x.WardId,
                        principalTable: "Wards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    PayBatchBillId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                    TransRef = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TransNote = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Success = table.Column<bool>(type: "boolean", maxLength: 255, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayBatchBillDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayBatchBillDetails_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PayBatchBillDetails_PayBatchBills_PayBatchBillId",
                        column: x => x.PayBatchBillId,
                        principalTable: "PayBatchBills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnits_UserId",
                table: "AbpOrganizationUnits",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUserProfile_CityId",
                table: "AbpUserProfile",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpUserProfile_DistrictId",
                table: "AbpUserProfile",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpUserProfile_UserId",
                table: "AbpUserProfile",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpUserProfile_WardId",
                table: "AbpUserProfile",
                column: "WardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_UserSaleLeadId",
                table: "AbpUsers",
                column: "UserSaleLeadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountBlockBalanceDetails_AccountBlockBalanceId",
                table: "AccountBlockBalanceDetails",
                column: "AccountBlockBalanceId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountBlockBalances_TenantId",
                table: "AccountBlockBalances",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountBlockBalances_TransCode",
                table: "AccountBlockBalances",
                column: "TransCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccountBlockBalances_UserId",
                table: "AccountBlockBalances",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChangeUserNameHistories_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposits_UserSaleId",
                table: "Deposits",
                column: "UserSaleId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountDetails_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountDetails_ServiceId",
                table: "DiscountDetails",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeeDetails_ProductId",
                table: "FeeDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_FeeDetails_ServiceId",
                table: "FeeDetails",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LimitProductDetails_CategoryId",
                table: "LimitProductDetails",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitProductDetails_LimitProductId",
                table: "LimitProductDetails",
                column: "LimitProductId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitProductDetails_ProductId",
                table: "LimitProductDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitProductDetails_ServiceId",
                table: "LimitProductDetails",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitProducts_Code",
                table: "LimitProducts",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LimitProducts_TenantId",
                table: "LimitProducts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitProducts_UserId",
                table: "LimitProducts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationSchedules_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayBackDetails_PayBackId",
                table: "PayBackDetails",
                column: "PayBackId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBackDetails_UserId",
                table: "PayBackDetails",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBatchBillDetails_PayBatchBillId",
                table: "PayBatchBillDetails",
                column: "PayBatchBillId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBatchBillDetails_UserId",
                table: "PayBatchBillDetails",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBatchBills_CategoryId",
                table: "PayBatchBills",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBatchBills_ProductId",
                table: "PayBatchBills",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PayBatchBills_TenantId",
                table: "PayBatchBills",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleAssignAgents_SaleUserId",
                table: "SaleAssignAgents",
                column: "SaleUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleAssignAgents_UserAgentId",
                table: "SaleAssignAgents",
                column: "UserAgentId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleClearDebtHistories_UserId",
                table: "SaleClearDebtHistories",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleClearDebts_BankId",
                table: "SaleClearDebts",
                column: "BankId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleClearDebts_TenantId",
                table: "SaleClearDebts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleClearDebts_UserId",
                table: "SaleClearDebts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleLimitDebts_TenantId",
                table: "SaleLimitDebts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleLimitDebts_UserId",
                table: "SaleLimitDebts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleManLocations_CityId",
                table: "SaleManLocations",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleManLocations_DistrictId",
                table: "SaleManLocations",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleManLocations_UserId",
                table: "SaleManLocations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleManLocations_WardId",
                table: "SaleManLocations",
                column: "WardId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceConfigurations_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceConfigurations_ProviderId",
                table: "ServiceConfigurations",
                column: "ProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceConfigurations_TenantId",
                table: "ServiceConfigurations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceConfigurations_UserId",
                table: "ServiceConfigurations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffConfigurations_UserId",
                table: "StaffConfigurations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemAccountTransfers_TenantId",
