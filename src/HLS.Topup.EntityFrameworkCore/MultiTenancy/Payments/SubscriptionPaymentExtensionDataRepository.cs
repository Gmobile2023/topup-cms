...
using HLS.Topup.EntityFrameworkCore.Repositories;

namespace HLS.Topup.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : TopupRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TopupDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
