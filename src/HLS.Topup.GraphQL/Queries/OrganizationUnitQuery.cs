...
using HLS.Topup.Core.Base;
using HLS.Topup.Core.Extensions;
using HLS.Topup.Dto;
using HLS.Topup.Types;

namespace HLS.Topup.Queries
{
    public class OrganizationUnitQuery : TopupQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
