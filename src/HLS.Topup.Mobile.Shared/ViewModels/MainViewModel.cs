...
using HLS.Topup.Commands;
using HLS.Topup.Core.Threading;
using HLS.Topup.Models.NavigationMenu;
using HLS.Topup.Services.Navigation;
...
using HLS.Topup.ApiClient;
using HLS.Topup.Controls;
using HLS.Topup.Dto;
using HLS.Topup.Extensions;
using HLS.Topup.Localization;
using HLS.Topup.UI;
using HLS.Topup.UI.Assets;
using HLS.Topup.Views;
using DependencyResolver = HLS.Topup.Core.Dependency.DependencyResolver;
...
namespace HLS.Topup.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Topup";
