...
{
    public class TopupAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public TopupAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
