...
using HLS.Topup.Web.Models.TokenAuth;
...
namespace HLS.Topup.Web.Controllers
{
    ...
    public class TokenAuthController : TopupControllerBase
    {
        ...
        public TokenAuthController(
            ...
            IUserDelegationManager userDelegationManager, IHttpContextAccessor httpContextAccessor,
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            // var appRequestInfo = _httpContextAccessor.HttpContext.Request.Headers["app_request_info"];
