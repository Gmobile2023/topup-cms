...
namespace HLS.Topup.Web.IdentityServer
{
    public static class IdentityServerBuilderExtensions
    {
        ...
        private const string ValidationCertificatePathIsNotSpecified =
            "Validation certificate file path is not specified";
        ...
        {
            var certificateConfiguration = configuration.GetSection("IdentityServer:CertificateConfiguration")
