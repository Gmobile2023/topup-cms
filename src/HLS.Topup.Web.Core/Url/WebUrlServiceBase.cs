...
namespace HLS.Topup.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public abstract string ServerFileAddressFormatKey { get; }
        ...
        public string ServerFileAddressFormat => _appConfiguration[ServerFileAddressFormatKey] ?? "https://localhost:44302/";
        ...
        public string GetServerFileAddress(string tenancyName = null)
        {
            return ReplaceTenancyNameInUrl(ServerFileAddressFormat, tenancyName);
        }
