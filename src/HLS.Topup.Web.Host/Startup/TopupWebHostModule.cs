...
using HLS.Topup.Web.Startup.ExternalLoginInfoProviders;
...
namespace HLS.Topup.Web.Startup
{
    ...
    public class TopupWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TopupWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TopupWebHostModule).GetAssembly());
        }
