...
using HLS.Topup.Web.Models.Consent;
using IdentityServer4.Validation;
using ServiceStack;

namespace HLS.Topup.Web.Controllers
{
    public class ConsentController : TopupControllerBase
    {
        ...
        {
            Console.WriteLine($"Index {returnUrl}");
        ...
        {
            Console.WriteLine($"ConsentInputModel {model?.ToJson()}");
            var result = await ProcessConsent(model);
            Console.WriteLine($"ConsentInputModel return {result.ToJson()}");
        ...
        {
            Console.WriteLine($"ProcessConsent {model?.ToJson()}");
        ...
        private async Task<ConsentViewModel> BuildViewModelAsync(string returnUrl, ConsentInputModel model = null)
        {
            ...
            //var a = _resourceStore.FindEnabledIdentityResourcesByScopeAsync().ToJson();
            var resources =
