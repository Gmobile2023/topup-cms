...
{
    public class HeaderViewComponent : TopupViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string currentPageName = "")
        {
            ...
            var headerModel = new HeaderViewModel
            {
                ...
                Menu = await _userNavigationManager.GetMenuAsync(MenuNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
            ...
            return View("Default", headerModel);
        }
    }
}
