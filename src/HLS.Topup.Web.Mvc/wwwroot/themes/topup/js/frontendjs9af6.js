if (!function (n, t) {
    ...
    return yi.href = at.href, i.extend({
        ...
        var f, e, o,
            s = t.jsonp !== !1 && (ii.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && ii.test(t.data) && "data");
...
window.Modernizr = function (n, t, i) {
    ...
    function w(n, t) {
        var u, r;
        for (u in n)
            if (r = n[u], !tt(r, "-") && k[r] !== i) return t == "pfx" ? r : !0;
        return !1
    }
    ...
    function f(n, t, i) {
        ...
        return u(t, "string") || u(t, "undefined") ? w(f, t) : (f = (n + " " + nt.join(r + " ") + r).split(" "), it(f, t, i))
    }
    ...
    var r = {},
        ...
        o, v = {}.hasOwnProperty,
        y, s;
    y = !u(v, "undefined") && !u(v.call, "undefined") ? function (n, t) {
        return v.call(n, t)
    } : function (n, t) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function (n) {
        ...
        return i = a.call(arguments, 1), r = function () {
            ...
            }, f.prototype = t.prototype, e = new f, u = t.apply(e, i.concat(a.call(arguments))), Object(u) === u ? u : e) : t.apply(n, i.concat(a.call(arguments)))
        }, r
    });
    e.cssanimations = function () {
        return f("animationName")
    };
    for (s in e) y(e, s) && (o = s.toLowerCase(), r[o] = e[s](), l.push((r[o] ? "" : "no-") + o));
    return r.addTest = function (n, t) {
        if (typeof n == "object")
            for (var u in n) y(n, u) && r.addTest(u, n[u]);
        else {
            if (n = n.toLowerCase(), r[n] !== i) return r;
            t = typeof t == "function" ? t() : t;
            typeof h != "undefined" && h && (c.className += " " + (t ? "" : "no-") + n);
            r[n] = t
        }
        return r
    }, p(""), b = rt = null,
        function (n, t) {
            ...
            n.html5 = r;
            c(t)
        }(this, t), r._version = "2.8.3", r._domPrefixes = nt, r._cssomPrefixes = g, r.testProp = function (n) {
        return w([n])
    }, r.testAllProps = f, r.prefixed = function (n, t, i) {
        return t ? f(n, t, i) : f(n, "pfx")
    }, c.className = c.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + l.join(" ") : ""), r
}(this, this.document),
    function (n, t, i) {
        function h(n) {
...
Modernizr.load = function () {
    ...
    function (n) {
        ...
        typeof define == "function" && define.amd ? define(u) : n.classie = u
    }(window),
    function () {
        function i() {
            var n = !1;
            ...
            r = function (i, r) {
                var u = function (i) {
                    if (n.animations) {
                        ...
                        this.removeEventListener(t, u)
                    }
                    r && typeof r == "function" && r.call()
                };
                n.animations ? i.addEventListener(t, u) : u()
            },
            u = i() ? "touchstart" : "click";
        [].slice.call(document.querySelectorAll(".cbutton")).forEach(function (n) {
            n.addEventListener(u, function () {
                classie.add(n, "cbutton--click");
                r(classie.has(n, "cbutton--complex") ? n.querySelector(".cbutton__helper") : n, function () {
                    classie.remove(n, "cbutton--click")
                })
            })
        })
    }(),
    function (n) {
        ...
        Zoomify.prototype.zoomIn = function () {
            var t = this,
                s = this.$image.css("transform");
            this.transition(this.$image, "none");
            this.transform("none");
            var r = this.$image.offset(),
                u = this.$image.outerWidth(),
                f = this.$image.outerHeight(),
                h = this.$image[0].naturalWidth || +Infinity,
                c = this.$image[0].naturalHeight || +Infinity,
                e = n(window).width(),
                o = n(window).height(),
                l = Math.min(h, e * this.options.scale) / u,
                a = Math.min(c, o * this.options.scale) / f,
                i = Math.min(l, a),
                v = (-r.left + (e - u) / 2) / i,
        ...
        Zoomify.prototype.addShadow = function () {
            ...
            if (!this._zoomed) {
                ...
                n(".section-body.row").append(this.$shadow);
            ...
            return n && n.fn && n.fn.select2 && n.fn.select2.amd && (t = n.fn.select2.amd),
                function () {
                    if (!t || !t.requirejs) {
                        ...
                        !function (t) {
                            ...
                            function c(n, t) {
                                var e, s, o, r, h, y, c, w, i, l, p, u = t && t.split("/"),
                                    a = f.map,
                                    v = a && a["*"] || {};
                                if (n && "." === n.charAt(0))
                                    if (t) {
                                        for (n = n.split("/"), h = n.length - 1, f.nodeIdCompat && b.test(n[h]) && (n[h] = n[h].replace(b, "")), n = u.slice(0, u.length - 1).concat(n), i = 0; i < n.length; i += 1)
                                ...
                                if ((u || v) && a) {
                                    for (e = n.split("/"), i = e.length; i > 0; i -= 1) {
                                        if (s = e.slice(0, i).join("/"), u)
                                            for (l = u.length; l > 0; l -= 1)
                                                if (o = a[u.slice(0, l).join("/")], o && (o = o[s])) {
                                                    r = o;
                                                    y = i;
                                                    break
                                                }
                            ...
                            function p(n, i) {
                                return function () {
                                    ...
                                    return "string" != typeof r[0] && 1 === r.length && r.push(null), o.apply(t, r.concat([n, i]))
                                }
                            }
                            ...
                            v = function (n, t) {
                                var r, u = w(n),
                                    i = u[0];
                                return n = u[1], i && (i = c(i, t), r = l(i)), i ? n = r && r.normalize ? r.normalize(n, k(t)) : c(n, t) : (n = c(n, t), u = w(n), i = u[0], n = u[1], i && (r = l(i))), {
                                    f: i ? i + "!" + n : n,
                                    n: n,
                                    pr: i,
                                    p: r
                            ...
                            a = function (n, i, r, f) {
                                ...
                                if (f = f || n, "undefined" === nt || "function" === nt) {
                                    for (i = !i.length && r.length ? ["require", "exports", "module"] : i, c = 0; c < i.length; c += 1)
                                        if (b = v(i[c], f), o = b.f, "require" === o) a[c] = s.require(n);
                            ...
                            n = i = o = function (n, i, r, u, e) {
                                if ("string" == typeof n) return s[n] ? s[n](i) : l(v(n, i).f);
                                if (!n.splice) {
                                    if (f = n, f.deps && o(f.deps, f.callback), !i) return;
                                    i.splice ? (n = i, i = r, r = null) : n = t
                                }
                                return i = i || function () {
                                }, "function" == typeof r && (r = u, u = e), u ? a(t, n, i, r) : setTimeout(function () {
                                    a(t, n, i, r)
                                }, 4), o
                            };
                            o.config = function (n) {
                ...
                function r(n) {
                    var i = n.prototype,
                        r = [],
                        t, u;
                    for (t in i) u = i[t], "function" == typeof u && "constructor" !== t && r.push(t);
                    return r
                }
                ...
                return t.Extend = function (n, t) {
                    ...
                    for (var r, t = "", i = 0; n > i; i++) r = Math.floor(36 * Math.random()), t += r.toString(36);
                    return t
                }, t.bind = function (n, t) {
                    return function () {
                        n.apply(t, arguments)
                ...
                return t.Extend(i, t.Observable), i.prototype.render = function () {
                    ...
                    var i, t, r, u;
                    if (this.hideLoading(), i = [], null == n.results || 0 === n.results.length) return void (0 === this.$results.children().length && this.trigger("results:message", {
                        message: "noResults"
                    }));
                    ...
                    if (t.children) {
                        for (o = n(r), u = document.createElement("strong"), u.className = "select2-results__group", n(u), this.template(t, u), s = [], f = 0; f < t.children.length; f++) l = t.children[f], a = this.option(l), s.push(a);
                        h = n("<ul><\/ul>", {
                    ...
                    t.on("results:select", function () {
                        var n = i.getHighlightedResults(),
                            t;
                        0 !== n.length && (t = n.data("data"), "true" == n.attr("aria-selected") ? i.trigger("close", {}) : i.trigger("select", {
                            data: t
                        }))
                    });
                ...
                return i.prototype.bind = function (n, t, i) {
                    ...
                    var r, u, i, f;
                    if (!this.options.get("disabled") && (r = this.$selection.find(".select2-selection__clear"), 0 !== r.length)) {
                ...
                return r.prototype.render = function (t) {
                    ...
                    this.$selection.on("keyup.search input.search", ".select2-search--inline", function (n) {
                        if (e && "input" === n.type) return void u.$selection.off("input.search input.searchcheck");
                        var t = n.which;
                    ...
                    n = "";
                    "" !== this.$search.attr("placeholder") ? n = this.$selection.find(".select2-selection__rendered").innerWidth() : (t = this.$search.val().length + 1, n = .75 * t + "em");
                ...
                return n.Extend(t, n.Observable), t.prototype.current = function () {
                    ...
                    var r = t.id + "-result-";
                    return r += n.generateChars(4), r + (null != i.id ? "-" + i.id.toString() : "-" + n.generateChars(4))
                }, t
                ...
                return t.Extend(r, n), r.prototype.current = function (n) {
                    ...
                    var t = this,
                        r;
                    if (n.selected = !0, i(n.element).is("option")) return n.element.selected = !0, void this.$element.trigger("change");
                    this.$element.prop("multiple") ? this.current(function (r) {
                        var f = [],
                            u, e;
                        for (n = [n], n.push.apply(n, r), u = 0; u < n.length; u++) e = n[u].id, -1 === i.inArray(e, f) && f.push(e);
                        t.$element.val(f);
                        t.$element.trigger("change")
                    }) : (r = n.id, this.$element.val(r), this.$element.trigger("change"))
                }, r.prototype.unselect = function (n) {
                    var t = this;
                    if (this.$element.prop("multiple")) return n.selected = !1, i(n.element).is("option") ? (n.element.selected = !1, void this.$element.trigger("change")) : void this.current(function (r) {
                        for (var e, u = [], f = 0; f < r.length; f++) e = r[f].id, e !== n.id && -1 === i.inArray(e, u) && u.push(e);
                        t.$element.val(u);
                        t.$element.trigger("change")
                    })
                }, r.prototype.bind = function (n) {
                    ...
                    f.each(function () {
                        var t = i(this),
                            e, f;
                        (t.is("option") || t.is("optgroup")) && (e = u.item(t), f = u.matches(n, e), null !== f && r.push(f))
                    });
                    t({
                        results: r
                    })
                    ...
                    var t, u, r;
                    return n.children ? (t = document.createElement("optgroup"), t.label = n.text) : (t = document.createElement("option"), void 0 !== t.textContent ? t.textContent = n.text : t.innerText = n.text), n.id && (t.value = n.id), n.disabled && (t.disabled = !0), n.selected && (t.selected = !0), n.title && (t.title = n.title), u = i(t), r = this._normalizeItem(n), r.element = t, i.data(t, "data", r), u
                    ...
                    if (n.is("option")) t = {
                        ...
                        for (var u = n.children("option"), f = [], r = 0; r < u.length; r++) e = i(u[r]), o = this.item(e), f.push(o);
                        t.children = f
                    }
                    ...
                    return null != n.id && (n.id = n.id.toString()), null != n.text && (n.text = n.text.toString()), null == n._resultId && n.id && null != this.container && (n._resultId = this.generateResultId(this.container, n)), i.extend({}, {
                        selected: !1,
                        disabled: !1
                    }, n)
                ...
                return t.Extend(r, n), r.prototype.select = function (n) {
                    ...
                    for (var r, f, h, l = this, e = this.$element.find("option"), a = e.map(function () {
                        ...
                        if (r = this._normalizeItem(n[u]), i.inArray(r.id, a) >= 0) {
                            var s = e.filter(c(r)),
                                v = this.item(s),
                                y = i.extend(!0, {}, r, v),
                                p = this.option(y);
                            s.replaceWith(p)
                        } else f = this.option(r), r.children && (h = this.convertToOptions(r.children), t.appendMany(f, h)), o.push(f);
                    return o
                }, r
                ...
                function t(t, i, r) {
                    var f = r.get("tags"),
                        o = r.get("createTag"),
                        e, u;
                    if (void 0 !== o && (this.createTag = o), e = r.get("insertTag"), void 0 !== e && (this.insertTag = e), t.call(this, i, r), n.isArray(f))
                ...
                return t.prototype.query = function (n, t, i) {
                    function u(n, f) {
                        ...
                        if (f) return !0;
                        s = r.createTag(t);
                        null != s && (c = r.option(s), c.attr("data-select2-tag", !0), r.addOptions([c]), r.insertTag(e, s));
                        n.results = e;
                        i(n)
                    }

                    var r = this;
                    return this._removeOldTags(), null == t.term || null != t.page ? void n.call(this, t, i) : void n.call(this, t, u)
                ...
                return t.prototype.bind = function (n, t, i) {
                    ...
                    for (var o, h = r.get("tokenSeparators") || [], e = i.term, f = 0, c = this.createTag || function (n) {
                        ...
                        if (o = e[f], -1 !== n.inArray(o, h)) {
                            var l = e.substr(0, f),
                                a = n.extend({}, i, {
                                    term: l
                                }),
                                s = c(a);
                            null != s ? (u(s), e = e.substr(f + 1) || "", f = 0) : f++
                        } else f++;
                    return {
                        term: e
                    }
                ...
                return i.prototype.bind = function (n, t, i) {
                    ...
                    t.on("open", function () {
                        ...
                        u || (u = !0, t.on("results:all", function () {
                            r._positionDropdown();
                            r._resizeDropdown()
                ...
                return n.prototype.bind = function (n, t, i) {
                    ...
                    var r, u, i;
                    t && null != t.originalSelect2Event && (r = t.originalSelect2Event, "select" === r._type || "unselect" === r._type) || (u = this.getHighlightedResults(), u.length < 1 || (i = u.data("data"), null != i.element && i.element.selected || null == i.element && i.selected || this.trigger("select", {
                        data: i
                    })))
                }, n
                ...
                return {
                    ...
                    maximumSelected: function (n) {
                        var t = "Bạn chỉ có thể chọn " + n.maximum + " lựa chọn, bỏ chọn để chọn thêm!";
                        return 1 != n.maximum && (t += ""), t
                    },
                    noResults: function () {
                ...
                st.prototype.reset = function () {
                    ...
                    function t(r, u) {
                        ...
                        if (u.children && u.children.length > 0) {
                            for (f = n.extend(!0, {}, u), e = u.children.length - 1; e >= 0; e--) o = u.children[e], s = t(r, o), null == s && f.children.splice(e, 1);
                ...
                function u(t, u) {
                    if (this.options = t, null != u && this.fromElement(u), this.options = i.apply(this.options), u && u.is("input")) {
                ...
                return i.Extend(u, i.Observable), u.prototype._generateId = function (n) {
                    var t = "";
                    return t = null != n.attr("id") ? n.attr("id") : null != n.attr("name") ? n.attr("name") + "-" + i.generateChars(2) : i.generateChars(4), t = t.replace(/(:|\.|\[|\]|,)/g, ""), t = "select2-" + t
                    ...
                    if ("element" == t) return u = n.outerWidth(!1), 0 >= u ? "auto" : u + "px";
                    if ("style" == t) {
                        if (f = n.attr("style"), "string" != typeof f) return null;
                        for (var o = f.split(";"), e = 0, h = o.length; h > e; e += 1)
                            if (s = o[e].replace(/\s/g, ""), i = s.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== i && i.length >= 1) return i[1];
                        return null
                    }
                    return t
