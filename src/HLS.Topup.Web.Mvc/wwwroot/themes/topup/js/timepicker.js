...
function _isTime2(time_str, format, ampm_text){
...
function _formattedTimeToInt2(time_str, format, ampm_text){
 if (typeof ampm_text === "undefined"){
   // default am/pm text
   ampm_text = { am: "am", pm: "pm", AM: "AM", PM: "PM" };
 }
...
function _scrollToHourOption2(select, hour){
...
function _scrollToMinuteOption2(select, minute){
  var options = select.options;
  var len = options.length;
...
(function($){
  ...
  function _createTimepicker($input){
    ...
    ok_button.className = "col-md-6 btn btn-outline-primary ok-button";
    cancel_button.className = "col-md-6 btn btn-outline-secondary cancel-button";
  ...
  $.fn.timepicker.default_options = {
    ...
    scrollDefaultHour: null,
    scrollDefaultMinute: null,
    selectOnBlur: false,
    selectSize: 8,
    timeFormat: "%H:%i",
