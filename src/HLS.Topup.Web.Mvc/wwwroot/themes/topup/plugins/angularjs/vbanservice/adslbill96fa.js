...
//                             ADSL CONTROLLER
//=============================================================================================
topupApp.controller('ADSLController', ["$scope", "$locale", function ($scope, $locale) {
    //==================================GLOBAL METHOD===============================================
    //Global Init value
    ...
    $scope.validGiftCode = function () {
        if ($scope.giftcode === '' || typeof $scope.giftcode === 'undefined') {
            ...
            $.ajax({
                ...
                data: {
                    addData: encodeURIComponent("ADSL-" + $scope.billcode),
    ...
    $scope.nextToPay = function () {
        $('#steponeForm').submit(function (e) {
            ...
            messages: {
                ...
                billcode: {
                    required: "Vui lòng nhập mã ADSL",
