...
//=============================================================================================
topupApp.controller('HocPhiController', ["$scope", "$locale", function ($scope, $locale) {
    //Global Init value
    ...
    $scope.validGiftCode = function () {
        if ($scope.giftcode === '' || typeof $scope.giftcode === 'undefined') {
            ...
            $.ajax({
                ...
                data: {
                    addData: "HOCPHIBILLING-" + $scope.cusmobile,
        ...
        $('#steponeForm').submit(function (e) {
            ...
            submitHandler: function (form) {
                ...
                if (!$scope.isReadTerm) {
                    ...
                    $.ajax({
                                    url: "../../service/hocphi-bill/getbill",
                                    data: {
                                    ...
                                    success: function (data) {
                                        if (data.Code === '00') {
                                            ...
                                            $scope.svName = data.svName;
                                            $scope.billNo = data.billNo;
                                            $scope.billAddress = data.billAddress;
                                            $scope.billHocKy = data.billHocKy;
                ...
                var steptwovalidator = $('#steptwoform').validate({
                    ...
                    submitHandler: function (form) {
                        if ($scope.payMethod === "VISAMASTER") {
                            ...
                            $.ajax({
                                url: "../../service/hocphi-bill/execute",
                                data: {
                                    billcode: encodeURIComponent($scope.billcode),
                                    providerid: $scope.provider,
                                    cusmobile: $scope.cusmobile,
