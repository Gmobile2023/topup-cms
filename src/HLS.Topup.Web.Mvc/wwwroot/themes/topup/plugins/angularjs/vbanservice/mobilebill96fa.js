//=============================================================================================
//                              MOBILE BILL CONTROLLER
//=============================================================================================
topupApp.controller('MobileBillController', ["$scope", "$locale", function ($scope, $locale) {
    //Global Init value
    ...
    $scope.nextToPay = function () {
        $('#steponeForm').submit(function (e) {
            ...
            rules: {
                cusmobile: {
                    required: true,
                    regx: /^(096|097|098|0162|0163|0164|0165|0166|0167|0168|0169|086|032|033|034|035|036|037|038|039|0129|0127|0125|0124|0123|094|091|088|081|082|083|084|085|087|090|093|0120|0121|0122|0126|0128|089|070|076|077|078|079|092|0188|0186|056|058|099|0199|059)\d{7}$/
                },
                amount: {
                    required: true
                },
            ...
            submitHandler: function (form) {
                ...
                if (!$scope.isReadTerm) {
                    ...
                    //Check Bill (If Vinaphone)
                    if ($scope.isvinaphone === "1") {

                        $.ajax({
                            url: "../../service/mobile-bill/getbill",
                            data: {
                            ...
                            success: function (data) {
                                if (data.Code === '00') {
                                    ...
                                    //check minmax amount
                                    if ($scope.amount < 10000 || $scope.amount > 1000000000) {
                        ...
                        if ($scope.amount < 10000 || $scope.amount > 1000000000) {
                            ...
                            if ($scope.giftcode !== '' && typeof $scope.giftcode !== 'undefined') { //Use GiftCode
                                ...
                                //=================BEGIN QRCODE======================
                                //$.ajax({
                                //    url: "../../service/mobile-bill/gen-qrcode",
                                //    data: {
                                //        cusmobile: $scope.cusmobile,
                                //        amount: $scope.amount,
                                //        giftcode: $scope.giftcode
                ...
                $('#steptwoform').submit(function (e) {
                    ...
                    submitHandler: function (form) {
                        if ($scope.payMethod === "VISAMASTER") {
                            ...
                            $.ajax({
                                url: "../../service/mobile-bill/execute",
                                data: {
                                    cusmobile: $scope.cusmobile,
                                    amount: $scope.amount,
