//=============================================================================================
//                              PSTN BILL CONTROLLER
//=============================================================================================
topupApp.controller('PstnBillController', ["$scope", "$locale", function ($scope, $locale) {
    //Global Init value
    ...
    $scope.getSerivces = function () {
        $.ajax({
            url: "../../service/pstn-bill/getservice",
            type: "POST",
            beforeSend: function () {
            },
            complete: function () {
        ...
        if ($scope.giftcode === '' || typeof $scope.giftcode === 'undefined') {
            ...
            //} else {
                $.ajax({
                    ...
                    data: {
                        addData: "PSTNBILLING-" + $scope.cusmobile,
    ...
    $scope.nextToPay = function () {
        $('#steponeForm').submit(function (e) {
            ...
            messages: {
                ...
                billcode: {
                    required: function () {
                        if ($scope.provider === "VNPT_MEDIA") {
                            return "Vui lòng nhập số điện thoại/mã khách hàng";
                        } else {
                        ...
                        success: function (data) {
                            if (data.Code === '00') {
                                ...
                                if ($scope.giftcode !== '' && typeof $scope.giftcode !== 'undefined') { //Use GiftCode
                                    ...
                                    //=================BEGIN QRCODE======================
                                    //$.ajax({
                                    //    url: "../../service/pstn-bill/gen-qrcode",
                                    //    data: {
                                    //        billcode: encodeURIComponent($scope.billcode),
