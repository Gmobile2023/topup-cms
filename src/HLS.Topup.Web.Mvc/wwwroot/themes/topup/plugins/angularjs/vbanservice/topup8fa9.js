...
//                              TOPUP CONTROLLER
//=============================================================================================
topupApp.controller('TopupControlller', ["$scope", "$locale", function ($scope, $locale) {
    //Init value
    ...
    $scope.detectmobile = function () {
        //var initCheck = $scope.cusmobile.slice(0, 3);
        var initCheck = $scope.cusmobile;
        var viettelRegx =
            /^(096|097|098|0162|0163|0164|0165|0166|0167|0168|0169|086|032|033|034|035|036|037|038|039)\d{7}$/;
        var isCheckViettel = viettelRegx.test(initCheck);
        if (isCheckViettel) {
    ...
    $scope.nextToPay = function () {
        $('#steponeForm').submit(function (e) {
            ...
            rules: {
                cusmobile: {
                    required: true,
                    regx: /^(096|097|098|0162|0163|0164|0165|0166|0167|0168|0169|086|032|033|034|035|036|037|038|039|094|091|088|081|082|083|084|085|087|090|093|089|070|076|077|078|079|092|0188|0186|056|058|099|0199|059|052)\d{7}$/
                }
            },
            messages: {
                cusmobile: {
            ...
            submitHandler: function (form) {
                ...
                if (!$scope.isReadTerm) {
                    ...
                    if ($scope.giftcode !== '' && typeof $scope.giftcode !== 'undefined') { //Use GiftCode
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.Code === '00') {
                                    $scope.isGiftCodeNotApproved = '0';
                                    $scope.panelStatus = 2;
                                    $scope.amountpay = $scope.cardPrice - $scope.giftcodevalue;
                                    ...
                                    $scope.isGiftCodeValid = '0';
                                    $scope.isGiftCodeNotValid = '0';
                                    $scope.amountpay = $scope.cardPrice;
                                    $scope.giftcodevalue = 0;
                                    $scope.panelStatus = 2;
                                }
                                if (!$scope.$$phase)
                        ...
                        //$scope.isHasQr = "0";
                        //$.ajax({
                        //    url: "../../service/topup/gen-qrcode",
                        //    data: {
                        //        cusmobile: $scope.cusmobile,
                        //        pricetopup: $scope.cardPrice,
                        //        giftcode: $scope.giftcode
                        //    },
                        //    type: "POST",
                        //    beforeSend: function () {
        ...
        if ($scope.payMethod === "VISAMASTER") {
            $('#steptwoform').submit(function (e) {
                ...
                rules: {
                    ...
                    visaCusMobile: {
                        required: true,
                        regx: /^(096|097|098|0162|0163|0164|0165|0166|0167|0168|0169|086|032|033|034|035|036|037|038|039|0129|0127|0125|0124|0123|094|091|088|081|082|083|084|085|087|090|093|0120|0121|0122|0126|0128|089|070|076|077|078|079|092|0188|0186|056|058|099|0199|059|052)\d{7}$/
                    },
                    visaCusAddress: {
                        required: true,
                        minlength: 5,
