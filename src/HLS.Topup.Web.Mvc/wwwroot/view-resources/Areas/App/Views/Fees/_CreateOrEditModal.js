(function ($) {
    app.modals.CreateOrEditFeeModal = function () {
        ...
        this.init = function (modalManager) {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<input class="fees form-control amount-mask txtMinFee text-right" id="txtMinFee_' + row.productId + '" data-id=' + row.productId + ' data-pname="' + row.productName + '" type="text" data-amount="' + minFee + '" value = ' + (data === null ? "" : data) + '   >';
                        }
                    },
                    {
                        targets: 3,
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<input class="fees form-control amount-mask txtAmountMinFee text-right" id="txtAmountMinFee_' + row.productId + '" data-id=' + row.productId + ' data-pname="' + row.productName + '" type="text" data-amount="' + amountMinFee + '" value = ' + (data === null ? "" : data) + '   >';
                        }
                    },
                    {
                        targets: 4,
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<input class="fees form-control amount-mask txtAmountIncrease text-right" id="txtAmountIncrease_' + row.productId + '" data-id=' + row.productId + ' data-pname="' + row.productName + '" type="text" data-amount="' + amountIncrease + '" value = ' + (data === null ? "" : data) + '   >';
                        }
                    },
                    {
                        targets: 5,
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<input class="fees form-control amount-mask txtSubFee text-right" id="txtSubFee_' + row.productId + '" data-id=' + row.productId + ' data-pname="' + row.productName + '" type="text" data-amount="' + subFee + '" value = ' + (data === null ? "" : data) + '   >';
                        }
                    },
                    {
                        targets: 6,
            ...
            productFeesList.on('order.dt search.dt', function () {
                productFeesList.column(0, {
                    search: 'applied',
                    order: 'applied'
        ...
        $(document).on('change', '.fees', function () {
            let id = $(this).attr('data-id');
            // var t1 = $('#txtMinFee_' + id).val() != '';
            // var t2 = $('#txtMinFee_' + id).val() != '' && $('#txtAmountMinFee_' + id).val() != '';
            // var t3 = $('#txtMinFee_' + id).val() != '' && $('#txtAmountMinFee_' + id).val() != '' && $('#txtAmountIncrease_' + id).val() != '';
            // var t4 = $('#txtMinFee_' + id).val() != '' && $('#txtAmountMinFee_' + id).val() != '' && $('#txtAmountIncrease_' + id).val() != '' && $('#txtSubFee_' + id).val() != '';
            // var t5 = $('#txtAmountMinFee_' + id).val() != '' && $('#txtAmountIncrease_' + id).val() != '' && $('#txtSubFee_' + id).val() != '';
            //
            // if (t1 || t2 || t3 || t4 || t5) {
            //     alert("đúng");
            // } else {
        ...
        this.save = function () {
            ...
            fee.listUserId = $('#Fee_AgentId').val();
