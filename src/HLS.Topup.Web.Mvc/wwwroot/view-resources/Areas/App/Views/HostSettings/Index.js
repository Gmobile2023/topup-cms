(function ($) {
    $(function () {
        ...
        var _$otpSettingsFormItems = $('#OtpSettingsForm')
            .find('input')
            .not('#Setting_VerifySms_IsEnabled')
            .closest('.checkbox');

        var _$otpSettingsFormItems1 = $('#OtpSettingsForm')
            .find('input')
            .not('#Setting_VerifySms_IsEnabled')
            .closest('.form-group');

        var _$otpSettingsFormItems2 = $('#OtpSettingsForm')
            .find('select')
            .not('#Setting_VerifySms_IsEnabled')
            .closest('.form-group');
        ...
        function toggleOtpSettingsFormItems() {
            if ($('#Setting_VerifySms_IsEnabled').is(':checked')) {
                _$otpSettingsFormItems.slideDown('fast');
                _$otpSettingsFormItems1.slideDown('fast');
                _$otpSettingsFormItems2.slideDown('fast');
            } else {
                _$otpSettingsFormItems.slideUp('fast');
                _$otpSettingsFormItems1.slideUp('fast');
                _$otpSettingsFormItems2.slideUp('fast');
            }
        }
        ...
        $('#Setting_VerifySms_IsEnabled').change(function () {
            toggleOtpSettingsFormItems();
        });
        ...
        $('#SaveAllSettingsButton').click(function () {
            ...
            _hostSettingsService.updateAllSettings({
                ...
                security: {
                    ...
                    otpSettings: $('#OtpSettingsForm').serializeFormToObject()
                },
        ...
        $('#SendTestEmailButton').click(function () {
            _hostSettingsService.sendTestEmail({
                ...
                abp.message.info(app.localize('TestEmailSentSuccessfully'));
            });
        });
