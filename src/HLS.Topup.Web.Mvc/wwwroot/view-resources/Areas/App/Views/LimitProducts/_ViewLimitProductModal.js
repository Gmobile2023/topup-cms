(function ($) {
    app.modals.ViewLimitProductModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            limitProductList = _$limitProductsTable.DataTable({
                ...
                data: _$data,
                listAction: {
                    ajaxFunction: _limitProductsService.getLimitProductsDetailsTable,
                    inputFilter: function () {
                        return {
                            limitProductId: $('input[name="id"]').val(),
                        };
                    }
                },
                ordering: false,
        ...
        $('#ExportLimitProductList').click(function () {
            _limitProductsService
                .getDetailLimitProductsToExcel({
                    limitProductId: $('input[name="id"]').val()
                })
