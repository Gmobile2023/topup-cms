                                ...
                                function (isConfirmed) {
                                    if (isConfirmed) {
                                        _organizationUnitService.moveOrganizationUnit({
                                            ...
                                            abp.message.success(app.localize('SuccessfullyMoved'));
        ...
        var members = {
            ...
            add: function (users) {
                ...
                _organizationUnitService.addUsersToOrganizationUnit({
                    ...
                    abp.message.success(app.localize('SuccessfullyAdded'));
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            _organizationUnitService.removeUserFromOrganizationUnit({
                                ...
                                abp.message.success(app.localize('SuccessfullyRemoved'));
