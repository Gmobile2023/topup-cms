(function ($) {
    app.modals.CreateOrEditPartnerServiceConfigurationModal = function () {
        ...
        var _ServiceConfigurationserviceLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/PartnerServiceConfigurations/ServiceLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/PartnerServiceConfigurations/_ServiceConfigurationServiceLookupTableModal.js',
            modalClass: 'ServiceLookupTableModal'
        }); var _ServiceConfigurationproviderLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/PartnerServiceConfigurations/ProviderLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/PartnerServiceConfigurations/_ServiceConfigurationProviderLookupTableModal.js',
            modalClass: 'ProviderLookupTableModal'
        }); var _ServiceConfigurationcategoryLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/PartnerServiceConfigurations/CategoryLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/PartnerServiceConfigurations/_ServiceConfigurationCategoryLookupTableModal.js',
            modalClass: 'CategoryLookupTableModal'
        }); var _ServiceConfigurationproductLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/PartnerServiceConfigurations/ProductLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/PartnerServiceConfigurations/_ServiceConfigurationProductLookupTableModal.js',
            modalClass: 'ProductLookupTableModal'
        }); var _ServiceConfigurationuserLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/PartnerServiceConfigurations/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/PartnerServiceConfigurations/_ServiceConfigurationUserLookupTableModal.js',
        ...
        this.save = function () {
            ...
            _serviceConfigurationsService.createOrEdit(
                ...
                _modalManager.close();
                abp.event.trigger('app.CreateOrEditPartnerServiceConfigurationModalSaved');
            }).always(function () {
