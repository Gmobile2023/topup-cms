    ...
    $(function () {
        ...
        var _$permissionFilterModal = app.modals.PermissionTreeModal.create({
            onSelectionDone: function (filteredPermissions) {
                ...
                abp.message.success(app.localize('XCountPermissionFiltered', filteredPermissionCount));
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _userService.unlockUser({
                                    ...
                                    abp.message.success(app.localize('UnlockedTheUser', data.record.userName));
                                });
                            }
                        }, {
                            ...
                            action: function (data) {
                                _dynamicPropertiesModal.open({
                                    entityFullName: 'HLS.Topup.Authorization.Users.User',
        ...
        $('#ImportUsersFromExcelButton').fileupload({
            ...
            dropZone: $('#UsersTable'),
                ...
                if (jsonResult.success) {
                    abp.message.info(app.localize('ImportUsersProcessStart'));
                } else {
                    abp.message.warn(app.localize('ImportUsersUploadFailed'));
                }
            }
