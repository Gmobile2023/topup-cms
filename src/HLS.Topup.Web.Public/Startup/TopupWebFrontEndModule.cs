...
namespace HLS.Topup.Web.Public.Startup
{
    ...
    public class TopupWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TopupWebFrontEndModule(IWebHostEnvironment env, TopupEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TopupWebFrontEndModule).GetAssembly());
        }
    }
}
