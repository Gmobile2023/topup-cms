...
using HLS.Topup.MultiTenancy.HostDashboard;
...
namespace HLS.Topup.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TopupDbContext context, SubscriptionPayment subscriptionPayment)
        {
